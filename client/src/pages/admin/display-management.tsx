...
export default function DisplayManagement() {
  ...
  return (
    <VStack gap={6} align="stretch">
      <AdminPageHeader
        title="Displays"
        description="Controle os ecrãs que mostram chamadas, filas e media por área."
        action={<Button colorPalette="teal" onClick={() => { setForm({ name: '', areaId: '', username: '', password: '' }); setCreateOpen(true); }}>+ Display</Button>}
      />
